...
function addCombo(){
  ...
  tbody.innerHTML = `<tr>
    ...
    <tr>
      <td rowspan="2" colspan="6"><textarea name="combo${num}Note" row="2" placeholder="解説"></textarea></td>
...
function addWeapon(){
  ...
  tbody.innerHTML = `
    ...
    <td><textarea name="weapon${num}Note" row="2"></textarea></td>
  `;
...
function addArmor(){
  ...
  tbody.innerHTML = `
    ...
    <td><textarea name="armor${num}Note" row="2"></textarea></td>
  `;
...
function addVehicle(){
  ...
  tbody.innerHTML = `
    ...
    <td><textarea name="vehicle${num}Note" row="2"></textarea></td>
  `;
...
function addItem(){
  ...
  tbody.innerHTML = `
    ...
    <td><textarea name="item${num}Note" row="2"></textarea></td>
  `;
