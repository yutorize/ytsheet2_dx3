...
require './lib/dx3/palette-sub.pl';
...
<head>
  ...
  <link rel="stylesheet" media="all" href="./skin/css/dx3/edit.css?0.99.9">
  <script src="./skin/js/lib/Sortable.min.js"></script>
  <script src="./lib/dx3/edit-chara.js?0.99.9" defer></script>
...
print <<"HTML";
          <tbody id="combo${num}">
            ...
            <tr>
              <td rowspan="2" colspan="6"><textarea name="combo${num}Note" row="2" placeholder="解説">$pc{"combo${num}Note"}</textarea></td>
            ...
            <tr>
              <td>@{[input "combo${num}Condition3"]}</td>
              <td>@{[input "combo${num}Dice3"]}</td>
              <td>@{[input "combo${num}Crit3"]}</td>
              <td>@{[input "combo${num}Fixed3"]}</td>
              <td>@{[input "combo${num}Atk3"]}</td>
            </tr>
          </tbody>
HTML
}
...
print <<"HTML";
            <tr id="weapon${num}">
              ...
              <td><textarea name="weapon${num}Note" row="2">$pc{"weapon${num}Note"}</textarea></td>
            </tr>
HTML
}
print <<"HTML";
...
print <<"HTML";
            <tr id="armor${num}">
              ...
              <td><textarea name="armor${num}Note" row="2">$pc{"armor${num}Note"}</textarea></td>
            </tr>
HTML
}
print <<"HTML";
...
print <<"HTML";
            <tr id="vehicle${num}">
              ...
              <td><textarea name="vehicle${num}Note" row="2">$pc{"vehicle${num}Note"}</textarea></td>
            </tr>
HTML
}
print <<"HTML";
...
print <<"HTML";
            <tr id="item${num}">
              ...
              <td><textarea name="item${num}Note" row="2">$pc{"item${num}Note"}</textarea></td>
            </tr>
HTML
}
print <<"HTML";
