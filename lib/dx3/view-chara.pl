...
foreach (1 .. $pc{'comboNum'}){
  next if(
    ...
    !$pc{'combo'.$_.'Dice2'} && !$pc{'combo'.$_.'Crit2'} && !$pc{'combo'.$_.'Atk2'} && !$pc{'combo'.$_.'Fixed2'} && 
    !$pc{'combo'.$_.'Dice3'} && !$pc{'combo'.$_.'Crit3'} && !$pc{'combo'.$_.'Atk3'} && !$pc{'combo'.$_.'Fixed3'}
  );
  push(@combos, {
